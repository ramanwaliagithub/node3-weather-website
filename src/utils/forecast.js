    ...
    request({ url: url, json: true}, (error, {body}) => {
        if (error) {
            ...
            callback (undefined, {
                ...
                current: body.current.weather_descriptions[0] + ' throughout the day. Temperature is ' + body.current.temperature + ' and feels like ' + body.current.feelslike + ' and ' + body.current.precip + '% chance of rain.' + 'The humidity is ' + body.current.humidity + '%.'
            })
        }
    })
}
